...
description: 通过 REST API 搜索 78 个公共科学、生物医学、材料科学和经济数据库。涵盖物理/天文学（NASA、NIST、SDSS、SIMBAD、NASA Exoplanet Archive）、地球/环境（USGS、NOAA、EPA、OpenWeatherMap）、化学/药物（PubChem、ChEMBL、DrugBank、FDA、KEGG、ZINC、BindingDB、DailyMed、ChEBI）、材料（Materials Project、COD）、生物学/基因组学（Reactome、UniProt、STRING、Ensembl、NCBI Gene、GEO、GTEx、PDB、AlphaFold、InterPro、BioGRID、Gene Ontology、dbSNP、gnomAD、ENCODE、Human Protein Atlas、Human Cell Atlas、BRENDA、QuickGO、NCBI Protein/Taxonomy、SRA、ENA、UCSC Genome、JASPAR、MouseMine、PRIDE、LINCS L1000、RummaGEO、Metabolomics Workbench、EMDB、Addgene）、疾病/临床（COSMIC、Open Targets、ClinicalTrials.gov、OMIM、ClinVar、GDC/TCGA、cBioPortal、DisGeNET、GWAS Catalog、Monarch、HPO、ClinPGx）、监管（FDA、USPTO、SEC EDGAR）、经济/金融（FRED、World Bank、US Treasury、BEA、BLS、Federal Reserve、ECB、Alpha Vantage、Data Commons）、人口统计学（US Census、Eurostat、WHO）。当用户查找化合物、基因、蛋白质、通路、变体、临床试验、专利、经济指标或任何公共数据库 API 查询时使用。
metadata:
