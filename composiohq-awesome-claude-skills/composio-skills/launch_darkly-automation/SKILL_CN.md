...
# 通过 Rube MCP 进行 Launchdarkly 自动化

通过 Rube MCP 使用 Composio 的 Launchdarkly 工具包自动化 Launchdarkly 操作。
...
| 操作 | 方法 |
|-----------|----------|
| 查找工具 | `RUBE_SEARCH_TOOLS` with LaunchDarkly-specific use case |
| 连接 | `RUBE_MANAGE_CONNECTIONS` with toolkit `launch_darkly` |
