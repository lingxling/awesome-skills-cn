...
### 2. 执行 Google Search Console 操作s
...
| 操作 | 方法 |
|-----------|----------|
| 查找工具 | `RUBE_SEARCH_TOOLS` with Google Search Console-specific use case |
| 连接 | `RUBE_MANAGE_CONNECTIONS` with toolkit `google_search_console` |
