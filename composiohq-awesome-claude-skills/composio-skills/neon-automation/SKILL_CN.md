...
2. 连接 your Neon account when prompted (API key authentication)
...
| 连接ion URI is a secret | The returned URI includes credentials. Never log, display, or share it in plain text. |
