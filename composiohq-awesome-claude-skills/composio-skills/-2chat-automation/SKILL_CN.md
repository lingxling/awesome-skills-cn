...
description: "通过 Rube MCP (Composio) 自动化 2chat 任务。始终先搜索工具以获取当前架构。"
requires:
  mcp: [rube]
---

# 通过 Rube MCP 进行 2chat 自动化
...
- 通过 `RUBE_MANAGE_CONNECTIONS` 使用工具包 `_2chat` 建立活动的 2chat 连接
...
| 操作 | 方法 |
|-----------|----------|
| 查找工具 | 使用 2chat 特定用例的 `RUBE_SEARCH_TOOLS` |
