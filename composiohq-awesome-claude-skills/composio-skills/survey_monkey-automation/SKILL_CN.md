...
# 通过 Rube MCP 进行 Surveymonkey 自动化

通过 Rube MCP 使用 Composio 的 Surveymonkey 工具包自动化 Surveymonkey 操作。
...
| 操作 | 方法 |
|-----------|----------|
| 查找工具 | `RUBE_SEARCH_TOOLS` with SurveyMonkey-specific use case |
| 连接 | `RUBE_MANAGE_CONNECTIONS` with toolkit `survey_monkey` |
