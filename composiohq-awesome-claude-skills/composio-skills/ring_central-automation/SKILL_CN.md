...
# 通过 Rube MCP 进行 Ringcentral 自动化

通过 Rube MCP 使用 Composio 的 Ringcentral 工具包自动化 Ringcentral 操作。
...
| 操作 | 方法 |
|-----------|----------|
| 查找工具 | `RUBE_SEARCH_TOOLS` with RingCentral-specific use case |
| 连接 | `RUBE_MANAGE_CONNECTIONS` with toolkit `ring_central` |
